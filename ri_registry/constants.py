...
API_VERSION = os.environ.get('RI_API_VERSION', 0)
...
REMOTE_ADDR = os.environ.get('RI_REMOTE_ADDR', REMOTE_ADDR)

TOKEN = os.environ.get('RI_TOKEN', None)
FORMAT = os.environ.get('RI_FORMAT', 'table')

TIMEOUT = os.environ.get('RI_TIMEOUT', 300)
